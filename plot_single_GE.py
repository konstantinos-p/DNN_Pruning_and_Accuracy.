...
layer0 = np.load('cifar10/results/layer1_ac.npy')
layer1 = np.load('cifar10/results/layer2_ac.npy')
layer2 = np.load('cifar10/results/layer3_ac.npy')
layer3 = np.load('cifar10/results/layer4_ac.npy')
layer4 = np.load('cifar10/results/layer5_ac.npy')
layer5 = np.load('cifar10/results/layer6_ac.npy')
layer6 = np.load('cifar10/results/layer7_ac.npy')
layer7 = np.load('cifar10/results/layer8_ac.npy')
